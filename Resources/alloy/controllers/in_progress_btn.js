function Controller() {
    ...
    this.__controllerPath = "in_progress_btn";
    ...
    var exports = {};
    var __defers = {};
    $.__views.in_progress_btn = Ti.UI.createView(function() {
        var o = {};
        _.extend(o, {});
    ...
    $.__views.in_progress_btn && $.addTopLevelView($.__views.in_progress_btn);
    ...
    $.__views.in_progress_btn.add($.__views.button_container);
    ...
    $.__views.button_container.add($.__views.__alloyId34);
    $.__views.__alloyId35 = Ti.UI.createView(function() {
        var o = {};
        _.extend(o, {
            left: 10
        });
    ...
    $.__views.button_container.add($.__views.__alloyId35);
    ...
    $.__views.__alloyId35.add($.__views.title);

(function(t) {
    t.Parse = t.Parse || {}, t.Parse.VERSION = "js1.2.7";
})(this), function() {
    var t = this, e = t._, n = {}, i = Array.prototype, r = Object.prototype, s = Function.prototype, a = i.push, o = i.slice, u = i.concat, c = r.toString, l = r.hasOwnProperty, h = i.forEach, f = i.map, d = i.reduce, p = i.reduceRight, _ = i.filter, m = i.every, v = i.some, g = i.indexOf, b = i.lastIndexOf, y = Array.isArray, x = Object.keys, w = s.bind, O = function(t) {
        return t instanceof O ? t : this instanceof O ? (this._wrapped = t, void 0) : new O(t);
    };
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = O), 
    exports._ = O) : t._ = O, O.VERSION = "1.4.4";
    var E = O.each = O.forEach = function(t, e, i) {
    ...
    O.reduce = O.foldl = O.inject = function(t, e, n, i) {
        ...
        if (null == t && (t = []), d && t.reduce === d) return i && (e = O.bind(e, i)), 
        ...
        var r = arguments.length > 2;
        if (null == t && (t = []), p && t.reduceRight === p) return i && (e = O.bind(e, i)), 
    ...
    var A = O.some = O.any = function(t, e, i) {
        e || (e = O.identity);
        var r = !1;
    ...
    O.contains = O.include = function(t, e) {
        ...
        if (!e && O.isArray(t) && t[0] === +t[0] && 65535 > t.length) return Math.max.apply(Math, t);
        if (!e && O.isEmpty(t)) return -1 / 0;
        var i = {
            computed: -1 / 0,
            value: -1 / 0
        };
        ...
        if (!e && O.isArray(t) && t[0] === +t[0] && 65535 > t.length) return Math.min.apply(Math, t);
        if (!e && O.isEmpty(t)) return 1 / 0;
        var i = {
            computed: 1 / 0,
            value: 1 / 0
    ...
    var C = function(t, e, n) {
        return E(t, function(t) {
            O.isArray(t) ? e ? a.apply(n, t) : C(t, e, n) : n.push(t);
        }), n;
    };
    O.flatten = function(t, e) {
        ...
        for (var t = o.call(arguments), e = O.max(O.pluck(t, "length")), n = Array(e), i = 0; e > i; i++) n[i] = O.pluck(t, "" + i);
        return n;
        ...
        for (var i = Math.max(Math.ceil((e - t) / n), 0), r = 0, s = Array(i); i > r; ) s[r++] = t, 
        t += n;
        return s;
    }, O.bind = function(t, e) {
        ...
        var e = o.call(arguments, 1);
        return 0 === e.length && (e = O.functions(t)), E(e, function(e) {
            t[e] = O.bind(t[e], t);
        }), t;
        ...
        return function() {
            ...
            return n = this, i = arguments, 0 >= c ? (clearTimeout(r), r = null, a = u, s = t.apply(n, i)) : r || (r = setTimeout(o, c)), 
            s;
        };
        ...
        var e = {}, n = u.apply(i, o.call(arguments, 1));
        for (var r in t) O.contains(n, r) || (e[r] = t[r]);
        return e;
    ...
    var P = function(t, e, n, i) {
        ...
        var a = 0, o = !0;
        if ("[object Array]" == r) {
            if (a = t.length, o = a == e.length) for (;a-- && (o = P(t[a], e[a], n, i)); ) ;
        } else {
            var u = t.constructor, l = e.constructor;
            if (u !== l && !(O.isFunction(u) && u instanceof u && O.isFunction(l) && l instanceof l)) return !1;
            for (var h in t) if (O.has(t, h) && (a++, !(o = O.has(e, h) && P(t[h], e[h], n, i)))) break;
            if (o) {
                for (h in e) if (O.has(e, h) && !a--) break;
                o = !a;
            }
        }
    ...
    O.isEqual = function(t, e) {
        ...
        for (var e in t) if (O.has(t, e)) return !1;
        return !0;
    ...
    R.unescape = O.invert(R.escape);
    var I = {
        escape: RegExp("[" + O.keys(R.escape).join("") + "]", "g"),
        unescape: RegExp("(" + O.keys(R.unescape).join("|") + ")", "g")
    };
    O.each([ "escape", "unescape" ], function(t) {
        ...
        E(O.functions(t), function(e) {
            var n = O[e] = t[e];
            O.prototype[e] = function() {
                var t = [ this._wrapped ];
                return a.apply(t, arguments), L.call(this, n.apply(O, t));
            };
        });
    };
    var U = 0;
    ...
    O.template = function(t, e, n) {
        ...
        var r = RegExp([ (n.escape || k).source, (n.interpolate || k).source, (n.evaluate || k).source ].join("|") + "|$", "g"), s = 0, a = "__p+='";
    ...
    O.mixin(O), E([ "pop", "push", "reverse", "shift", "sort", "splice", "unshift" ], function(t) {
        var e = i[t];
    ...
    t.Parse = t.Parse || {};
    var e = t.Parse;
    "undefined" != typeof exports && exports._ ? (e._ = exports._.noConflict(), e.localStorage = require("localStorage"), 
    e.XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest, exports.Parse = e) : (e._ = _.noConflict(), 
    "undefined" != typeof localStorage && (e.localStorage = localStorage), "undefined" != typeof XMLHttpRequest && (e.XMLHttpRequest = XMLHttpRequest)), 
    "undefined" != typeof $ && (e.$ = $);
    var n = function() {}, i = function(t, i, r) {
        var s;
        return s = i && i.hasOwnProperty("constructor") ? i.constructor : function() {
            t.apply(this, arguments);
        }, e._.extend(s, t), n.prototype = t.prototype, s.prototype = new n(), i && e._.extend(s.prototype, i), 
        r && e._.extend(s, r), s.prototype.constructor = s, s.__super__ = t.prototype, s;
    };
    e.serverURL = "https://api.parse.com", "undefined" != typeof process && process.versions && process.versions.node && (e._isNode = !0), 
    e.initialize = function(t, n, i) {
        ...
        if ("undefined" != typeof XDomainRequest) return e._ajaxIE8(t, n, i)._thenRunCallbacks(a);
        ...
        }, c.open(t, n, !0), c.setRequestHeader("Content-Type", "text/plain"), e._isNode && c.setRequestHeader("User-Agent", "Parse/" + e.VERSION + " (NodeJS " + process.versions.node + ")"), 
        c.send(i), o._thenRunCallbacks(a);
        ...
        if ("batch" !== t && "classes" !== t && "files" !== t && "functions" !== t && "login" !== t && "push" !== t && "requestPasswordReset" !== t && "users" !== t) throw "Bad route: '" + t + "'.";
        var a = e.serverURL;
        "/" !== a.charAt(a.length - 1) && (a += "/"), a += "1/" + t, n && (a += "/" + n), 
        i && (a += "/" + i), s = e._.clone(s || {}), "POST" !== r && (s._method = r, r = "POST"), 
        s._ApplicationId = e.applicationId, e._useMasterKey ? s._MasterKey = e.masterKey : s._JavaScriptKey = e.javaScriptKey, 
        s._ClientVersion = e.VERSION, s._InstallationId = e._getInstallationId();
        ...
        return t instanceof e.Relation ? n(t) : e._.isArray(t) ? (e._.each(t, function(r, s) {
    ...
    e.Events = {
        on: function(t, e, i) {
            var r, s, a, o, u;
            if (!e) return this;
            for (t = t.split(n), r = this._callbacks || (this._callbacks = {}), s = t.shift(); s; ) u = r[s], 
            a = u ? u.tail : {}, a.next = o = {}, a.context = i, a.callback = e, r[s] = {
                tail: o,
                next: u ? u.next : a
            }, s = t.shift();
            return this;
        ...
        off: function(t, e, i) {
            ...
            if (s = this._callbacks) {
                ...
                for (t = t ? t.split(n) : _.keys(s), r = t.shift(); r; ) if (a = s[r], delete s[r], 
                a && (e || i)) {
                    for (o = a.tail, a = a.next; a !== o; ) u = a.callback, c = a.context, (e && u !== e || i && c !== i) && this.on(r, u, c), 
                    a = a.next;
                    r = t.shift();
                }
                return this;
        ...
        trigger: function(t) {
            ...
            for (u = s.all, t = t.split(n), c = i.call(arguments, 1), e = t.shift(); e; ) {
                if (r = s[e]) for (a = r.tail; (r = r.next) !== a; ) r.callback.apply(r.context || this, c);
                if (r = u) for (a = r.tail, o = [ e ].concat(c); (r = r.next) !== a; ) r.callback.apply(r.context || this, o);
                e = t.shift();
            }
            return this;
        }
    ...
    e.GeoPoint = function(t, i) {
        ...
        this.latitude = t.latitude, this.longitude = t.longitude) : n.isNumber(t) && n.isNumber(i) ? (e.GeoPoint._validate(t, i), 
        this.latitude = t, this.longitude = i) : (this.latitude = 0, this.longitude = 0);
        var r = this;
    ...
    e.ACL = function(t) {
        var i = this;
        if (i.permissionsById = {}, n.isObject(t)) if (t instanceof e.User) i.setReadAccess(t, !0), 
        i.setWriteAccess(t, !0); else {
        ...
        if (i instanceof e.User ? i = i.id : i instanceof e.Role && (i = "role:" + i.getName()), 
        !n.isString(i)) throw "userId must be a string.";
        ...
        if (t instanceof e.Role && (t = t.getName()), n.isString(t)) return this.setReadAccess("role:" + t, i), 
        void 0;
        throw "role must be a Parse.Role or a String";
    }, e.ACL.prototype.setRoleWriteAccess = function(t, i) {
        if (t instanceof e.Role && (t = t.getName()), n.isString(t)) return this.setWriteAccess("role:" + t, i), 
        void 0;
        throw "role must be a Parse.Role or a String";
    };
}(this), function(t) {
    ...
    e.Op = function() {
        ...
        _mergeWithPrevious: function(t) {
            if (t) {
                if (t instanceof e.Op.Unset) return new e.Op.Set(this.objects());
                if (t instanceof e.Op.Set) return new e.Op.Set(this._estimate(t.value()));
                if (t instanceof e.Op.AddUnique) return new e.Op.AddUnique(n.union(t.objects(), this.objects()));
                throw "Op is invalid after previous op.";
            }
            return this;
        },
        _estimate: function(t) {
            return t ? t.concat(n.difference(this.objects(), t)) : n.clone(this.objects());
        }
        ...
        toJSON: function() {
            ...
            return this.relationsToAdd.length > 0 && (s = n.map(this.relationsToAdd, r), t = {
                __op: "AddRelation",
                objects: s
            }), this.relationsToRemove.length > 0 && (s = n.map(this.relationsToRemove, r), 
            e = {
                __op: "RemoveRelation",
                objects: s
            }), t && e ? {
    ...
    e.Promise = function() {
        ...
        then: function(t, n) {
            ...
            return this._resolved ? r.apply(this, this._result) : this._rejected ? s(this._error) : (this._resolvedCallbacks.push(r), 
        ...
        _thenRunCallbacks: function(t, i) {
            ...
            return r = r || {}, this.then(function(t) {
                return r.success ? r.success.apply(this, arguments) : i && i.trigger("sync", i, t, r), 
                e.Promise.as.apply(e.Promise, arguments);
            }, function(t) {
                return r.error ? n.isUndefined(i) ? r.error(t) : r.error(i, t) : i && i.trigger("error", i, t, r), 
                e.Promise.error(t);
            });
        },
    ...
    var e = t.Parse, n = e._, i = function(t) {
        ...
        var i = new e.Promise();
        if ("undefined" == typeof FileReader) return e.Promise.error(new e.Error(-1, "Attempted to use a FileReader on an unsupported browser."));
        var r = new FileReader();
        return r.onloadend = function() {
            if (2 !== r.readyState) return i.reject(new e.Error(-1, "Error reading file.")), 
            void 0;
            var t = r.result, s = /^data:([^;]*);base64,(.*)$/.exec(t);
            return s ? (i.resolve(s[2], n || s[1]), void 0) : (i.reject(new e.Error(-1, "Unable to interpret data URL: " + t)), 
            void 0);
        }, r.readAsDataURL(t), i;
    };
    e.File = function(t, i, o) {
        ...
        if (n.isArray(i)) this._source = e.Promise.as(r(i), c); else if (i && i.base64) this._source = e.Promise.as(i.base64, c); else if ("undefined" != typeof File && i instanceof File) this._source = a(i, o); else if (n.isString(i)) throw "Creating a Parse.File from a String is not yet supported.";
    }, e.File.prototype = {
        name: function() {
            return this._name;
        },
    ...
    e.Object = function(t, i) {
        ...
        if (r && (t = n.extend({}, r, t)), i && i.collection && (this.collection = i.collection), 
        ...
        _toFullJSON: function(t) {
            ...
            return e._objectEach(i, function(n, r) {
                ...
                i[e] = t;
            }), n.has(this, "id") && (i.objectId = this.id), n.has(this, "createdAt") && (i.createdAt = n.isDate(this.createdAt) ? this.createdAt.toJSON() : this.createdAt), 
            n.has(this, "updatedAt") && (i.updatedAt = n.isDate(this.updatedAt) ? this.updatedAt.toJSON() : this.updatedAt), 
        ...
        escape: function(t) {
            ...
            return r = e._isNullOrUndefined(s) ? "" : n.escape("" + s), this._escapedAttributes[t] = r, 
            r;
        },
        has: function(t) {
        ...
        _mergeMagicFields: function(t) {
            ...
            e._arrayEach(r, function(r) {
                t[r] && ("objectId" === r ? i.id = t[r] : i[r] = "createdAt" !== r && "updatedAt" !== r || n.isDate(t[r]) ? t[r] : e._parseDate(t[r]), 
                delete t[r]);
            });
        },
        _startSave: function() {
        ...
        _finishSave: function(t) {
            ...
            this._opSetQueue = n.rest(this._opSetQueue), this._applyOpSet(r, this._serverData), 
        ...
        _rebuildEstimatedDataForKey: function(t) {
            ...
            e._arrayEach(this._opSetQueue, function(i) {
                var r = i[t];
        ...
        set: function(t, i, r) {
            ...
            return this._previousAttributes || {}, e._arrayEach(n.keys(s), function(t) {
                ...
                var a = !0;
                i instanceof e.Op.Set && n.isEqual(o.attributes[t], i.value) && (a = !1), a && (delete u[t], 
                r.silent ? o._silent[t] = !0 : r.changes[t] = !0);
                var c = n.last(o._opSetQueue);
                c[t] = i._mergeWithPrevious(c[t]), o._rebuildEstimatedDataForKey(t), a ? (o.changed[t] = o.attributes[t], 
                r.silent || (o._pending[t] = !0)) : (delete o.changed[t], delete o._pending[t]);
        ...
        save: function(t, i, r) {
            var s, a, o;
            if (n.isObject(t) || e._isNullOrUndefined(t) ? (s = t, o = i) : (s = {}, s[t] = i, 
            o = r), !o && s) {
            ...
            this._allPreviousSaves = this._allPreviousSaves._continueWith(function() {
                ...
                return c = c.then(function(t, e, i) {
                    var r = f.parse(t, e, i);
                    return o.wait && (r = n.extend(s || {}, r)), f._finishSave(r), o.wait && f.set(a, l), 
                    f;
                }, function(t) {
        ...
        parse: function(t, i) {
            ...
            }), r.updatedAt || (r.updatedAt = r.createdAt), i && (this._existed = 201 !== i), 
            r;
        },
        clone: function() {
        ...
        change: function(t) {
            ...
            e._objectEach(this.changed, a), r._previousAttributes = n.clone(this.attributes);
        ...
        if (n.has(e.Object._classMap, t)) {
            ...
            s = a._extend(i, r);
        } else i = i || {}, i.className = t, s = this._extend(i, r);
        ...
        e._traverse(t, function(t) {
            return t instanceof e.Object ? (t._refreshCache(), t.dirty() && n.push(t), void 0) : t instanceof e.File ? (t.url() || i.push(t), 
            void 0) : void 0;
        });
        ...
        return s.then(function() {
            return e.Promise._continueWhile(function() {
                ...
                if (e._arrayEach(o, function(e) {
                    return t.length > 20 ? (i.push(e), void 0) : (e._canBeSerialized() ? t.push(e) : i.push(e), 
                    void 0);
                }), o = i, 0 === t.length) return e.Promise.error(new e.Error(e.Error.OTHER_CAUSE, "Tried to save a batch with a cycle."));
                ...
                return e._arrayEach(t, function(t) {
                    ...
                    return e._request("batch", null, null, "POST", {
                        ...
                        return e._arrayEach(t, function(t, e) {
                            n[e].success ? t._finishSave(t.parse(n[e].success, i, r)) : (s = s || n[e].error, 
                            t._cancelSave());
    ...
    e.Role = e.Object.extend("_Role", {
        constructor: function(t, i) {
            n.isString(t) && i instanceof e.ACL ? (e.Object.prototype.constructor.call(this, null, null), 
            this.setName(t), this.setACL(i)) : e.Object.prototype.constructor.call(this, t, i);
        },
        getName: function() {
    ...
    e.Collection = function(t, e) {
        e = e || {}, e.comparator && (this.comparator = e.comparator), e.model && (this.model = e.model), 
        ...
        add: function(t, i) {
            ...
            for (r = 0; a > r; r++) (o = t[r]).on("all", this._onModelEvent, this), this._byCid[o.cid] = o, 
            o.id && (this._byId[o.id] = o);
            if (this.length += a, s = e._isNullOrUndefined(i.at) ? this.models.length : i.at, 
            this.models.splice.apply(this.models, [ s, 0 ].concat(t)), this.comparator && this.sort({
                silent: !0
            }), i.silent) return this;
            for (r = 0, a = this.models.length; a > r; r++) o = this.models[r], l[o.cid] && (i.index = r, 
            o.trigger("add", o, this, i));
            return this;
        },
        remove: function(t, e) {
            var i, r, s, a;
            for (e = e || {}, t = n.isArray(t) ? t.slice() : [ t ], i = 0, r = t.length; r > i; i++) a = this.getByCid(t[i]) || this.get(t[i]), 
            a && (delete this._byId[a.id], delete this._byCid[a.cid], s = this.indexOf(a), this.models.splice(s, 1), 
            this.length--, e.silent || (e.index = s, a.trigger("remove", a, this, e)), this._removeReference(a));
            return this;
        },
        get: function(t) {
    ...
    n.extend(e.View.prototype, e.Events, {
        ...
        setElement: function(t, n) {
            return this.$el = e.$(t), this.el = this.$el[0], n !== !1 && this.delegateEvents(), 
            this;
        },
    ...
    e.User = e.Object.extend("_User", {
        ...
        _linkWith: function(t, i) {
            var r;
            if (n.isString(t) ? (r = t, t = e.User._authProviders[t]) : r = t.getAuthType(), 
            n.has(i, "authData")) {
        ...
        signUp: function(t, i) {
            ...
            if (!s || "" === s) return r = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up user with an empty name."), 
            i && i.error && i.error(this, r), e.Promise.error(r);
            var a = t && t.password || this.get("password");
            if (!a || "" === a) return r = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up user with an empty password."), 
            i && i.error && i.error(this, r), e.Promise.error(r);
            var o = n.clone(i);
        ...
        save: function(t, i, r) {
            var s, a;
            n.isObject(t) || n.isNull(t) || n.isUndefined(t) ? (s = t, a = i) : (s = {}, s[t] = i, 
            a = r), a = a || {};
            var o = n.clone(a);
            return o.success = function(t) {
        ...
        logOut: function() {
            ...
            e.User._currentUserMatchesDisk = !0, e.User._currentUser = null, e.localStorage.removeItem(e._getParsePath(e.User._CURRENT_USER_KEY));
        },
        ...
        current: function() {
            ...
            if (!t) return null;
            e.User._currentUser = new e.Object._create("_User"), e.User._currentUser._isCurrentUser = !0;
            var n = JSON.parse(t);
            return e.User._currentUser.id = n._id, delete n._id, e.User._currentUser._sessionToken = n._sessionToken, 
            delete n._sessionToken, e.User._currentUser.set(n), e.User._currentUser._synchronizeAllAuthData(), 
    ...
    e.Query = function(t) {
        ...
        find: function(t) {
            ...
            return r.then(function(t) {
                return n.map(t.results, function(n) {
                    var r;
                    return r = t.className ? new e.Object(t.className) : new i.objectClass(), r._finishFetch(n, !0), 
                    r;
                });
            })._thenRunCallbacks(t);
        },
        ...
        _addCondition: function(t, n, i) {
            return this._where[t] || (this._where[t] = {}), this._where[t][n] = e._encode(i), 
            this;
        },
        ...
        matches: function(t, e, n) {
            return this._addCondition(t, "$regex", e), n || (n = ""), e.ignoreCase && (n += "i"), 
            e.multiline && (n += "m"), n && n.length && this._addCondition(t, "$options", n), 
            this;
        },
        ...
        withinGeoBox: function(t, n, i) {
            return n instanceof e.GeoPoint || (n = new e.GeoPoint(n)), i instanceof e.GeoPoint || (i = new e.GeoPoint(i)), 
        ...
        each: function(t, i) {
            ...
            s._limit = i.batchSize || 100, s._where = n.clone(this._where), s._include = n.clone(this._include), 
    ...
    e.History.started = !1, n.extend(e.History.prototype, e.Events, {
        ...
        getFragment: function(t, n) {
            if (e._isNullOrUndefined(t)) if (this._hasPushState || n) {
        ...
        start: function(t) {
            ...
            e.History.started = !0, this.options = n.extend({}, {
                root: "/"
            }, this.options, t), this._wantsHashChange = this.options.hashChange !== !1, this._wantsPushState = !!this.options.pushState, 
            this._hasPushState = !!(this.options.pushState && window.history && window.history.pushState);
            var s = this.getFragment(), a = document.documentMode, o = r.exec(navigator.userAgent.toLowerCase()) && (!a || 7 >= a);
            o && (this.iframe = e.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow, 
            this.navigate(s)), this._hasPushState ? e.$(window).bind("popstate", this.checkUrl) : this._wantsHashChange && "onhashchange" in window && !o ? e.$(window).bind("hashchange", this.checkUrl) : this._wantsHashChange && (this._checkUrlInterval = window.setInterval(this.checkUrl, this.interval)), 
            this.fragment = s;
            var u = window.location, c = u.pathname === this.options.root;
            return this._wantsHashChange && this._wantsPushState && !this._hasPushState && !c ? (this.fragment = this.getFragment(null, !0), 
            window.location.replace(this.options.root + "#" + this.fragment), !0) : (this._wantsPushState && this._hasPushState && c && u.hash && (this.fragment = this.getHash().replace(i, ""), 
            window.history.replaceState({}, document.title, u.protocol + "//" + u.host + this.options.root + this.fragment)), 
            this.options.silent ? void 0 : this.loadUrl());
        },
        stop: function() {
            e.$(window).unbind("popstate", this.checkUrl).unbind("hashchange", this.checkUrl), 
            window.clearInterval(this._checkUrlInterval), e.History.started = !1;
        },
        route: function(t, e) {
        ...
        navigate: function(t, n) {
            ...
            if (this.fragment !== r) {
                ...
                } else this._wantsHashChange ? (this.fragment = r, this._updateHash(window.location, r, n.replace), 
                this.iframe && r !== this.getFragment(this.getHash(this.iframe)) && (n.replace || this.iframe.document.open().close(), 
                this._updateHash(this.iframe.location, r, n.replace))) : window.location.assign(this.options.root + t);
    ...
    n.extend(e.Router.prototype, e.Events, {
        ...
        route: function(t, i, r) {
            return e.history = e.history || new e.History(), n.isRegExp(t) || (t = this._routeToRegExp(t)), 
            r || (r = this[i]), e.history.route(t, n.bind(function(n) {
